			...
			<div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
				...
				<div className="space-y-5">
					...
					<motion.div
						...
						className="relative overflow-hidden rounded-xl border border-secondary-400/20 dark:bg-primary-950/50 p-5 space-y-3">
						<CornerAccent position="top-right" />
						<CornerAccent position="bottom-left" />
						...
						{project.github && (
							<Link
								...
								target="_blank"
								rel="noopener noreferrer"
								className="flex items-center gap-2 w-full px-4 py-2.5 rounded-lg border border-primary-700 dark:bg-primary-900 hover:border-primary-600 hover:bg-primary-800/50 transition-all duration-200 text-sm font-medium dark:text-primary-200">
								<Github size={15} />
								Source Code
							</Link>
						)}
