			...
			{experiences.map((exp, index) => {
				...
				return (
					<motion.div
						...
						className="relative overflow-hidden rounded-2xl border border-secondary-400/20 dark:bg-primary-950/50 hover:border-secondary-400/40 hover:shadow-lg hover:shadow-secondary-400/8 transition-[border-color,box-shadow] duration-300 transform-gpu">
