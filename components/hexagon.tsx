...
function HexagonBackground({
  ...
  return (
    <div
      ...
      className={cn(
        'relative size-full overflow-hidden bg-secondary-400/20 dark:bg-secondary-400/20 [filter:drop-shadow(0_0_6px_theme(--color.secondary-400))]',
        className,
      )}
      {...props}
    >
              ...
              (_, colIndex) => (
                <div
                  ...
                  className={cn(
                    ...
                    'hover:before:bg-secondary-400/20 dark:hover:before:bg-secondary-400/20 hover:before:opacity-100 hover:before:duration-0 dark:hover:after:bg-neutral-800 hover:after:bg-neutral-50 hover:after:opacity-100 hover:after:duration-0',
